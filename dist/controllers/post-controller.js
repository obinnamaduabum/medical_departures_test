    ...
    static updatePost(req, res) {
        return __awaiter(this, void 0, void 0, function* () {
            try {
                ...
                if (!post) {
                    return api_response_util_1.ApiResponseUtil.notFound(res, 'Post not found');
                }
                const user = yield (post === null || post === void 0 ? void 0 : post.getUser());
                if ((user === null || user === void 0 ? void 0 : user.id) !== (verifyToken === null || verifyToken === void 0 ? void 0 : verifyToken.id)) {
